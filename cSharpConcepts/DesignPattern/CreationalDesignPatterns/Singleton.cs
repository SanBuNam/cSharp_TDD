...
namespace cSharpConcepts.DesignPattern.CreationalPatterns
{
    // Singleton is a creational design pattern, which ensures that only one object of its kind exists and provides a single points of access ot if for any other code.
    ...
    public sealed class Singleton
    {
        ...
        private Singleton() { }
        // The Singleton's instance is stored in a static field. There are multiple ways to initialize this field, all of them have various pros and cons.
        // We'll see the simplest of these ways, which, however, doesn't work really well in multithreaded program.
